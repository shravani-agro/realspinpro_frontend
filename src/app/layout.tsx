...
export const metadata: Metadata = {
  title: {
    default: "RealSpinPro | Premium Gaming Experience",
  ...
  openGraph: {
    ...
    title: "RealSpinPro | Premium Gaming Experience",
    description:
      "Join the ultimate wheel challenge experience. Play daily, unlock massive rewards, and climb the leaderboard.",
    images: [
      {
        url: "/logo.png",
        width: 1200,
        height: 630,
        alt: "RealSpinPro - Premium Gaming Experience",
      },
    ],
  },
  twitter: {
