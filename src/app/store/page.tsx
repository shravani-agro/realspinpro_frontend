            ...
            <div className="relative mb-8 group">
              <div className="flex gap-3 overflow-x-auto snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] -mx-5 px-5 md:mx-0 md:px-0">
                {[
                  ...
                  <div key={idx} className="shrink-0 w-[260px] h-[146px] md:w-[380px] md:h-[213px] bg-black rounded-[12px] md:rounded-[16px] overflow-hidden snap-center relative shadow-sm border border-gray-200">
                    <Image src={src} alt={`Screenshot ${idx + 1}`} fill sizes="(max-width: 768px) 260px, 380px" className="object-cover" />
                  </div>
                ))}
              </div>
